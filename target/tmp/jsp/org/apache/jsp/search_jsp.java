 ...
 * Generated at: 2017-09-12 13:42:45 UTC
...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"searchh(document.getElementById('form1').rssName.value)\">搜索</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul id=\"list\" class=\"dropdown-menu\" role=\"menu\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a id=\"items\" onclick=\"searchh(document.getElementById('items').innerText)\" href=\"javascript:void(0);\"></a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("/rssadmin/findAll.do\",\r\n");
      out.write("\t\t\t\"dataType\" : \"json\",\r\n");
      out.write("\t\t\tsuccess : function(result) {\r\n");
      out.write("\t\t\t\t$.each(result.list, function(i, items) {\r\n");
      out.write("\t\t\t\tconsole.log(items.id);\r\n");
      out.write("\t\t\t\t\t$(\"#list\").append(\r\n");
      out.write("\t\t\t\t\t\"<li><a id=\\\"\"+items.id+\r\n");
      out.write("\t\t\t\t\t\"\\\" onclick=\\\"searchh(document.getElementById('\"+items.id+\r\n");
      out.write("\t\t\t\t\t\"').innerText)\\\" href=\\\"javascript:void(0);\\\">\"+items.name+\r\n");
      out.write("\t\t\t\t\t\"</a></li>\"\r\n");
      out.write("\t\t\t\t\t);\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t},\r\n");
      ...
      out.write("\t\t})\r\n");
      out.write("});\r\n");
      out.write("\tfunction searchh(date) {\r\n");
